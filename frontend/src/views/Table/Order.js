...
import { addOrder, getTopProductsOfBranch } from "../../actions";
      ...
      <Container xs={12}>
        ...
        enableReinitialize
          ...
          validationSchema={Yup.object().shape({
            productId: Yup.string().max(255).required("Please select an item"),
            quantity: Yup.number().required("Please select quantity"),
          })}
          onSubmit={(values, formik) => {
            values.productName = products.reduce(function (
              productNameArray,
              product
            ) {
